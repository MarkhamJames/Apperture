...
export default class CreateLocaleForm extends Component {
  state = {
    name: '',
    image_url: '',
    description: '',
    ...
    return (
      <div className="createMain" id='login-box'>
        <form className="create" id='login-page' autoComplete='off' onSubmit={(e) => {
          e.preventDefault()
          this.props.createLocale(this.props.currentUser.id, this.state)
        }
        }>
          <label htmlFor="name">Name of Locale</label>
